<!DOCTYPE html>
<!-- saved from url=(0139)https://blackboard.umkc.edu/webapps/blackboard/execute/content/file?cmd=view&content_id=_1601641_1&course_id=_115426_1&framesetWrapped=true -->
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <title>SocketServer.cpp – COMP-SCI 423 0001- Client/Srvr Prog&amp;...</title>
...
<h1 class="hideoff hideFromQuickLinks">Open Quick Links</h1><div id="quick_links_wrap" style="top: 68px;"><a id="quick_links_lightbox_link" href="https://blackboard.umkc.edu/webapps/blackboard/execute/content/file?cmd=view&content_id=_1601641_1&course_id=_115426_1&framesetWrapped=true#" onclick="quickLinks.lightboxHelper.toggleLightbox(); return false;" role="button" aria-haspopup="true" tabindex="1" title="Open Quick Links">Quick Links</a></div><div id="quickLinksLightboxDiv" class="hideoff"><div class="ax-content"><div class="content-lite"><div id="quick_links_landmarks_section"><h2 class="hideFromQuickLinks">Page Landmarks</h2><ul class="shortcut-list" id="quick_links_landmark_list"></ul></div><div id="quick_links_headings_section"><h2 class="hideFromQuickLinks">Content Outline</h2><ul class="shortcut-list" id="quick_links_heading_list"></ul></div></div><div id="quick_links_hotkeys_section" class="legend"><h2 class="hideFromQuickLinks">Keyboard Shortcuts</h2><ul class="keycombos" id="quick_links_hotkey_list"></ul></div></div></div><h1 class="hideoff hideFromQuickLinks"></h1><div class="global-nav-bar-wrap"><div class="global-nav-bar logout"><a id="topframe.logout.label" href="https://blackboard.umkc.edu/webapps/login?action=logout" target="_top" class="nav-link logout-link" title="Logout"> Logout</a></div><div id="global-nav" class="global-nav-bar" role="navigation" data-preview="false"><div class="hideoff">Global Menu</div><a id="global-nav-link" class="nav-link u_floatThis-right" href="https://blackboard.umkc.edu/webapps/blackboard/execute/content/file?cmd=view&content_id=_1601641_1&course_id=_115426_1&framesetWrapped=true#global-nav-flyout" aria-haspopup="true" tabindex="1" accesskey="m" role="navigation" title="Open Global Navigation Menu"><img id="global-avatar" src="./SocketServer_files/avatar_150.gif" class="global-top-avatar" data-tool-title="User Avatar Image" alt="">Henry Ell<span id="badgeTotal" style="visibility: visible;" title=""><span class="hideoff" id="badgeAXLabel">Activity Updates</span><span class="badge" id="badgeTotalCount" title="">91</span></span><img src="./SocketServer_files/arrowDown-topnav.png" id="global-toggle-img" class="global-toggle" alt="Expand Global Nav"></a><div id="global-nav-flyout" class="flyout-menu" style="display: none;" role="application"><ul id="bottomButtons" class="bottom-buttons"><li class="bottom-buttons-home"><a id="topframe.home.label" href="http://www.umkc.edu/" target="_blank" class="home" title="Home" role="menuitem"> Home</a></li><li class="bottom-buttons-help"><a id="topframe.help.label" href="https://blackboard.umkc.edu/webapps/blackboard/execute/content/file?cmd=view&content_id=_1601641_1&course_id=_115426_1&framesetWrapped=true#" onclick="globalNavigation.openHelpWindow(&#39;http://www.umkc.edu/ia/it/blackboard/&#39;);" class="help" title="Help" role="menuitem"> Help</a></li></ul></div></div></div>
<!-- global_nav.jsp -->
...
<span class="contextMenuContainer" style=" display: inline;" bb:menugeneratorurl="/webapps/blackboard/execute/getCrossCourseMenuHTML?course_id=_115426_1" bb:navitem="" bb:contextparameters="" bb:menuorder="" bb:overwritenavitems="" bb:beforeshowfunc="">
  ...
  <a id="cmlink_e5d4872e687e4658a4556b9afc2e635d" onfocus="page.ContextMenu.LI(event, &#39;cmdiv_e5d4872e687e4658a4556b9afc2e635d&#39;,false);" onmouseover="page.ContextMenu.LI(event, &#39;cmdiv_e5d4872e687e4658a4556b9afc2e635d&#39;,false);" class="cmimg editmode jsInit " href="https://blackboard.umkc.edu/webapps/blackboard/execute/content/file?cmd=view&content_id=_1601641_1&course_id=_115426_1&framesetWrapped=true#contextMenu" title="Course-to-Course Navigation"> <img src="./SocketServer_files/cmlink_generic.gif" alt=""></a> 
   	...
   	<li><a href="https://blackboard.umkc.edu/webapps/blackboard/execute/content/file?cmd=view&content_id=_1601641_1&course_id=_115426_1&framesetWrapped=true#" title="Click to expand the breadcrumbs">...</a></li><li style="display: none;"> <a href="https://blackboard.umkc.edu/webapps/blackboard/content/listContent.jsp?course_id=_115426_1&content_id=_1569429_1&mode=reset" title="Lecture notes">                  Lecture notes
              </a>          </li>
   	...
   	<li class="placeholder">                   SocketServer.cpp
                        </li>
  </ol>
 </div>
...
<form id="content" name="content" action="https://blackboard.umkc.edu/webapps/blackboard/execute/content/listContentEditable.jsp" method="post">
  ...
  <input type="hidden" name="content_id" id="content_id" value="_1601641_1">
...
<iframe src="./SocketServer_files/SocketServer.html" id="cleanSlate" class="cleanSlate" onload="page.setIframeHeightAndWidth();" width="100%" style="height: 1896px; width: 1607px;"></iframe>
   </div>
            ...
            if ( window.DWREngine )
       {
        try {DWREngine.beginBatch();} catch(ignore) {}
                ...
                page.decoratePageBanner();
                                                             page.ContextMenu.hideMenuDiv('e5d4872e687e4658a4556b9afc2e635d');
